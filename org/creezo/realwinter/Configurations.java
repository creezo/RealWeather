...
public class Configurations {
    ...
    public Configurations(RealWinter plugin, FileConfiguration WinterConf, FileConfiguration DesertConf, FileConfiguration JungleConf, FileConfiguration GlobalConf) {
